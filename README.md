...
Auth Themes is a collection of themes for [Auth](https://github.com/ecletus/auth), which is a Golang authentication framework.

It aimis to reduce repeated code, make you be able to integrate [Auth](https://github.com/ecletus/auth) into your application with few lines of code.
...
func New(config *auth.Config) *auth.Auth {
  ...
  config.ViewPaths = append(config.ViewPaths, "github.com/ecletus/auth_themes/clean/views")
...
Refer Theme [Clean](https://github.com/ecletus/auth_themes/tree/master/clean) for more details
